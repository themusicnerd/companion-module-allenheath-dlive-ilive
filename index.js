	...
	getConfigFields() {
		return [
			...
			},
			{
				type: 'number',
				id: 'tcpPort',
				label: 'TCP Port (dLive advanced / iLive AHNet)',
				tooltip: 'TCP port used for dLive advanced commands and the iLive AHNet meter session. The normal value is 51321.',
				width: 6,
				default: 51321,
				min: 1,
				max: 65535,
			...
			},
			{
				...
				min: 1,
				max: 65535,
				isVisibleExpression: '$(config:model) == "iLive" && $(config:enableAhnetMeters)',
			},
			{
				type: 'number',
